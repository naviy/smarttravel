...
D:\data\git\Luxena.Travel\tools\FluentMigrator\Migrate.exe /conn "%connectionString%" /provider postgres /assembly %assembly% /verbose=false /profile OLAP /namespace Luxena.FluentMigrator.Olap