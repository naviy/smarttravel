...
-- 
-- alter table lt_avia_ticket add constraint aviaticket_faretotal_currency_fkey 
...
alter table lt_flight_segment add constraint flightsegment_amount_currency_fkey 
