...
"
	...
	public class AccountingCoreTests : DomainTest
	{
		...
		[DebuggerStepThrough]
		private Product NewProduct(int index) => new AviaTicket
		{
		...
		[DebuggerStepThrough]
		private Order NewOrder(int index) => new Order
		{
			IssueDate = DateTime.Today,
		...
		[DebuggerStepThrough]
		private OrderItem NewOrderItem(int index, Order order = null) => new OrderItem
		{
			Order = order,
			Text = "#" + index,
		...
		[DebuggerStepThrough]
		private Payment NewPayment(int index) => new CashInOrderPayment
		{
			Date = DateTime.Today,
		...
		[DebuggerStepThrough]
		private InternalTransfer NewInternalTransfer(int index, Order fromOrder, Order toOrder) => new InternalTransfer
		{
			Date = DateTime.Today,
			Number = "P.15-0000" + index,
			FromOrder = fromOrder,
