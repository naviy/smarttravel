		...
		public class EntityInfo
		{
			...
			public void Init(EntityInfo[] entities, IList<Type> assemblyTypes)
			{
				...
				DerivedEntities =
					...
					entities.Where(a => a.EntityType.IsSubclassOf(EntityType) || (a.IsEntityQuery && a.EntityType == EntityType)).ToArray();
			...
			public override bool Equals(object obj)
			{
				...
				return EntityType == info.EntityType && EntitySetType == info.EntitySetType;
			}
