...
namespace Luxena
{
	...
	public static class StringExtentions
	{
		...
		{
			return me == null ? null : string.Join(separator, me.Select(a => a?.ToString()));
		}
		...
		{
			return !string.IsNullOrEmpty(me) && values.Any(me.StartsWith);
		}

		[DebuggerStepThrough]
		public static bool EndsWith(this string me, params string[] values)
		{
			return !string.IsNullOrEmpty(me) && values.Any(me.EndsWith);
		}
