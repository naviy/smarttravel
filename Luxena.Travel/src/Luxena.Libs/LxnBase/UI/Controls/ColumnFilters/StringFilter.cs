...
{
	public class StringFilter : EditorFilter
	{
		...
		public override Menu GetFilterMenu()
		{
			...
			CheckItem item = CreateCheckItem(groupId, FilterOperator.StartsWith, listeners);
			item.setChecked(true, true);
			Operator = FilterOperator.StartsWith;

			_checkItems.Add(item);
			_checkItems.Add(CreateCheckItem(groupId, FilterOperator.EndsWith, listeners));
			_checkItems.Add(CreateCheckItem(groupId, FilterOperator.Contains, listeners));
		...
		{
			_editor = new TextField(new Dictionary(
