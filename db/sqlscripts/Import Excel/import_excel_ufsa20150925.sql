...
select 
    ...
    0 as originator,
    5 as origin,
    case when departuretime2 is null
        then concat(d.airportcode1, '-', d.airportcode2)
        else concat(d.airportcode1, '-', d.airportcode2, '-', d.airportcode1)
    end as itinerary,
    d.seller,
    d.owner,
    o.customer,
    d.equalfare_amount as fare_amount,
    d.equalfare_currency as fare_currency,
    d.equalfare_amount,
    'UAH' as equalfare_currency,
    d.feestotal_amount as feestotal_amount,
...
select
 ...
 where (num = 0 and d.departuretime1 is not null) or (num = 1 and d.departuretime2 is not null)
