...
update lt_payment
 	set 
		class = case paymentform when 0 then 'Check' when 1 then 'WireTransfer' when 2 then 'Electronic' when 3 then 'Check' end,
		paymentform = case paymentform when 0 then 2 when 1 then 1 when 2 then 3 when 3 then 2 end;
