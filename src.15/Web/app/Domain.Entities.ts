module Luxena
{
	...
	export enum CheckItemTaxMode 
	{
		Default = 0,
		WithoutVAT = 1,
		WithoutVATAndServiceFeeVAT = 2,
	}

	export module CheckItemTaxMode
	{
		export var _ns = "Luxena.Travel.Domain";
		export var _name = "CheckItemTaxMode";
		export var _fullName = "Luxena.Travel.Domain.CheckItemTaxMode";
		export var _getEdm = value => !value ? null : new DevExpress.data.EdmLiteral("Luxena.Travel.Domain.CheckItemTaxMode'" + value + "'");
		...
		export var _items = {
			...
			"WithoutVAT": _array[1],
			"2": _array[2],
			"WithoutVATAndServiceFeeVAT": _array[2],
		};
