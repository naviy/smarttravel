...
namespace Luxena.Travel.Domain
{
	...
	public static class SemanticCodeGenerator
	{
		...
		public static List<string> GetCodeForTypeScript(ParameterInfo parameter, DefaultLocalizationTypesSource lng)
		{
			...
			AppendSimpleTypeTags(parameter.ParameterType, tags);
			return tags;
		}
		...
		private static void AppendTypeTags(MemberInfo prop, List<string> tags, bool appendType)
		{
			...
			if (AppendSimpleTypeTags(ptype, tags))
				return;
		...
		private static bool AppendSimpleTypeTags(Type ptype, List<string> tags)
		{
