...
namespace Luxena.Travel.Web
{
	...
	public partial class EmployeesController: EntityODataController<Domain, Person, string> 
	{
		protected override Domain.EntityQuery<Person> GetEntityQuery()
		{
			return db.Employees;
	...
	public partial class OpeningBalancesController: EntityODataController<Domain, OpeningBalance, string> 
	{
	}
	...
	public partial class EmployeeLookupController : EntityLookupODataController<Domain, Person, string, PersonLookup>
	{
	...
	public partial class OpeningBalanceLookupController : EntityLookupODataController<Domain, OpeningBalance, string, OpeningBalanceLookup>
	{
		public OpeningBalanceLookupController()
		{
			Query = db.OpeningBalances;
			Lookup = OpeningBalanceLookup.DefaultLookup;
			Select = OpeningBalanceLookup.SelectAndOrderByName;
		}
	}
	...
	public partial class OrderBalancesController: DbQueryODataController<Domain, OrderBalanceParams, OrderBalance, OrderBalanceQuery> { }
	...
	public class DomainFunctionsController: DomainODataController<Domain>
	{
		...
		[HttpGet, ODataRoute("OrderByAssignedTo_TotalByIssueDate(AssignedToId={AssignedToId})")]
		public IHttpActionResult OrderByAssignedTo_TotalByIssueDate([FromODataUri] string AssignedToId)
		{
			var result = db.OrderByAssignedTo_TotalByIssueDate(AssignedToId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("OrderByCustomer_TotalByIssueDate(CustomerId={CustomerId})")]
		public IHttpActionResult OrderByCustomer_TotalByIssueDate([FromODataUri] string CustomerId)
		{
			var result = db.OrderByCustomer_TotalByIssueDate(CustomerId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("OrderByOwner_TotalByIssueDate(OwnerId={OwnerId})")]
		public IHttpActionResult OrderByOwner_TotalByIssueDate([FromODataUri] string OwnerId)
		{
			var result = db.OrderByOwner_TotalByIssueDate(OwnerId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("ProductByBooker_TotalByIssueDate(BookerId={BookerId})")]
		public IHttpActionResult ProductByBooker_TotalByIssueDate([FromODataUri] string BookerId)
		{
			var result = db.ProductByBooker_TotalByIssueDate(BookerId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("ProductByProvider_TotalByIssueDate(ProviderId={ProviderId})")]
		public IHttpActionResult ProductByProvider_TotalByIssueDate([FromODataUri] string ProviderId)
		{
			var result = db.ProductByProvider_TotalByIssueDate(ProviderId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("ProductBySeller_TotalByIssueDate(SellerId={SellerId})")]
		public IHttpActionResult ProductBySeller_TotalByIssueDate([FromODataUri] string SellerId)
		{
			var result = db.ProductBySeller_TotalByIssueDate(SellerId);
			return Ok(result);
		}

		[HttpGet, ODataRoute("ProductByTicketer_TotalByIssueDate(TicketerId={TicketerId})")]
		public IHttpActionResult ProductByTicketer_TotalByIssueDate([FromODataUri] string TicketerId)
		{
			var result = db.ProductByTicketer_TotalByIssueDate(TicketerId);
			return Ok(result);
		}
	...
	partial class AppConfig
	{
		...
		public class DomainEdmModel
		{
			...
			public EntitySetConfiguration<Employee> Employees;
			public EntityTypeConfiguration<Employee> Employee;
			...
			public EntitySetConfiguration<OpeningBalance> OpeningBalances;
			public EntityTypeConfiguration<OpeningBalance> OpeningBalance;

			public EntitySetConfiguration<OrderBalance> OrderBalances;
			public EntityTypeConfiguration<OrderBalance> OrderBalance;
			...
			public EntitySetConfiguration<OrderBalanceParams> OrderBalanceParams;
			...
			public DomainEdmModel(ODataConventionModelBuilder mb)
			{
				...
				mb.ComplexType<OpeningBalanceReference>();
				...
				Employees = mb.EntitySet<Employee>("Employees");
				Employee = Employees.EntityType;
				mb.EntitySet<PersonLookup>("EmployeeLookup");
				...
				OpeningBalances = mb.EntitySet<OpeningBalance>("OpeningBalances");
				OpeningBalance = OpeningBalances.EntityType;
				mb.EntitySet<OpeningBalanceLookup>("OpeningBalanceLookup");

				OrderBalances = mb.EntitySet<OrderBalance>("OrderBalances");
				OrderBalance = OrderBalances.EntityType;
				...
				OrderBalanceParams = mb.EntitySet<OrderBalanceParams>("OrderBalanceParams");
				...
				AddDefaultFunctions(OpeningBalance);
				...
				mb.Function("OrderByAssignedTo_TotalByIssueDate")
					.ReturnsCollection<OrderTotalByDate>()
					.Parameter<string>("AssignedToId")
				;

				mb.Function("OrderByCustomer_TotalByIssueDate")
					.ReturnsCollection<OrderTotalByDate>()
					.Parameter<string>("CustomerId")
				;

				mb.Function("OrderByOwner_TotalByIssueDate")
					.ReturnsCollection<OrderTotalByDate>()
					.Parameter<string>("OwnerId")
				;

				mb.Function("ProductByBooker_TotalByIssueDate")
					.ReturnsCollection<ProductTotalByDate>()
					.Parameter<string>("BookerId")
				;

				mb.Function("ProductByProvider_TotalByIssueDate")
					.ReturnsCollection<ProductTotalByDate>()
					.Parameter<string>("ProviderId")
				;

				mb.Function("ProductBySeller_TotalByIssueDate")
					.ReturnsCollection<ProductTotalByDate>()
					.Parameter<string>("SellerId")
				;

				mb.Function("ProductByTicketer_TotalByIssueDate")
					.ReturnsCollection<ProductTotalByDate>()
					.Parameter<string>("TicketerId")
				;
