...
//			}
		...
		{
			var createAware = entity as ICreateAware;
			if (createAware == null) return false;
		...
		{
			var entityType = entity.GetClass().Type;

			if (_log.IsDebugEnabled)
				_log.Debug($"Add modification (class: {entityType.FullName}, type: {modification.Type}, instance: {id})");
