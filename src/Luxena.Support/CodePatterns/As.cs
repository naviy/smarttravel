...
namespace Luxena
{
	...
	public static partial class CodePatternExtentions
	{
		...
		{
			return me.HasValue ? evaluator(me) : default(T2);
		}
		...
		[DebuggerStepThrough]
		public static T2 As<T2>(this Match me, Func<Match, T2> evaluator)
		{
			return me.No() ? default(T2) : evaluator(me);
		}

		[DebuggerStepThrough]
		public static T2 As<T2>(this string me, Func<string, T2> evaluator)
		{
			return me.No() ? default(T2) : evaluator(me);
		}
