...
LxnBase.Log = function LxnBase_Log() {
}
LxnBase.Log.log = function LxnBase_Log$log(msg1, msg2, msg3, msg4, msg5) {
    /// <param name="msg1" type="Object">
    /// </param>
    /// <param name="msg2" type="Object">
    /// </param>
    /// <param name="msg3" type="Object">
    /// </param>
    /// <param name="msg4" type="Object">
    /// </param>
    /// <param name="msg5" type="Object">
    /// </param>
    /// <returns type="Object"></returns>
    if (!ss.isUndefined(msg5)) {
        eval('$log(msg1, msg2, msg3, msg4, msg5)');
        return msg5;
    }
    if (!ss.isUndefined(msg4)) {
        eval('$log(msg1, msg2, msg3, msg4)');
        return msg4;
    }
    if (!ss.isUndefined(msg3)) {
        eval('$log(msg1, msg2, msg3)');
        return msg3;
    }
    if (!ss.isUndefined(msg2)) {
        eval('$log(msg1, msg2)');
        return msg2;
    }
    eval('$log(msg1)');
...
LxnBase.Log.loga = function LxnBase_Log$loga(msg1, msg2, msg3, msg4, msg5) {
    /// <param name="msg1" type="Object">
    /// </param>
    /// <param name="msg2" type="Object">
    /// </param>
...
LxnBase.Log.logb = function LxnBase_Log$logb(msg) {
...
LxnBase.Log.loge = function LxnBase_Log$loge() {
    eval('$loge()');
}
LxnBase.Log.alert = function LxnBase_Log$alert(msg) {
    /// <param name="msg" type="Object">
    /// </param>
    /// <returns type="Object"></returns>
    eval('$log(msg)');
    alert((ss.isValue(msg)) ? msg.toString() : (ss.isNull(msg)) ? 'null' : 'undefined');
    return msg;
}
LxnBase.Log.trace = function LxnBase_Log$trace() {
    eval('console.trace()');
}
...
LxnBase.Data.RangeRequest.prototype = {
    ...
    setDefaultSort: function LxnBase_Data_RangeRequest$setDefaultSort(sort, dir) {
        /// <param name="sort" type="String">
        /// </param>
        /// <param name="dir" type="Boolean">
        /// </param>
        if (this.sort != null) {
            return;
        }
        this.sort = sort;
        this.dir = (dir) ? 'ASC' : 'DESC';
    },
...
////////////////////////////////////////////////////////////////////////////////
// LxnBase.Data.Reference

LxnBase.Data.Reference = function LxnBase_Data_Reference() {
    ...
    /// </field>
    /// <field name="NamePos" type="Number" integer="true" static="true">
    /// </field>
    /// <field name="TypePos" type="Number" integer="true" static="true">
    /// </field>
}
LxnBase.Data.Reference.create = function LxnBase_Data_Reference$create(type, name, id) {
    ...
    /// </param>
    /// <returns type="LxnBase.Data.Reference"></returns>
...
LxnBase.Data.Reference.createFromArray = function LxnBase_Data_Reference$createFromArray(array) {
    /// <param name="array" type="Object">
    /// </param>
    /// <returns type="LxnBase.Data.Reference"></returns>
    var info = new LxnBase.Data.Reference();
    var o = array;
    info.Type = o[LxnBase.Data.Reference.TypePos];
    info.Name = o[LxnBase.Data.Reference.NamePos];
    info.Id = o[LxnBase.Data.Reference.IdPos];
    return info;
}
LxnBase.Data.Reference.copy = function LxnBase_Data_Reference$copy(source) {
    /// <param name="source" type="LxnBase.Data.Reference">
    /// </param>
    /// <returns type="LxnBase.Data.Reference"></returns>
    if (source == null) {
        return null;
...
LxnBase.Data.Reference.equals = function LxnBase_Data_Reference$equals(obj1, obj2) {
    /// <param name="obj1" type="LxnBase.Data.Reference">
    /// </param>
    /// <param name="obj2" type="LxnBase.Data.Reference">
    /// </param>
    /// <returns type="Boolean"></returns>
    return obj1 != null && obj2 != null && obj1.Id === obj2.Id;
}
LxnBase.Data.Reference.prototype = {
    Id: null,
    Name: null,
    Type: null
}
...
LxnBase.Data.ItemResponse.create = function LxnBase_Data_ItemResponse$create(item) {
    /// <param name="item" type="Object">
    /// </param>
    /// <returns type="LxnBase.Data.ItemResponse"></returns>
    var r = new LxnBase.Data.ItemResponse();
    r.Item = item;
    return r;
}
...
LxnBase.Data.OperationPermissions = function LxnBase_Data_OperationPermissions() {
    /// <field name="CanList" type="LxnBase.Data.OperationStatus">
    /// </field>
    /// <field name="CanCreate" type="LxnBase.Data.OperationStatus">
    /// </field>
...
LxnBase.Data.ObjectPropertyNames = function LxnBase_Data_ObjectPropertyNames() {
    ...
    /// </field>
    /// <field name="version" type="String" static="true">
    /// </field>
    /// <field name="name" type="String" static="true">
    /// </field>
    /// <field name="type" type="String" static="true">
    /// </field>
    /// <field name="reference" type="String" static="true">
    /// </field>
    /// <field name="objectClass" type="String" static="true">
    /// </field>
}
...
LxnBase.Services.ListConfig = function LxnBase_Services_ListConfig() {
    ...
    /// <field name="IsCreationAllowed" type="LxnBase.Data.OperationStatus">
    /// </field>
    /// <field name="UseCustomCreation" type="Boolean">
    /// </field>
    /// <field name="IsCopyingAllowed" type="LxnBase.Data.OperationStatus">
    /// </field>
    /// <field name="IsEditAllowed" type="LxnBase.Data.OperationStatus">
...
////////////////////////////////////////////////////////////////////////////////
// LxnBase.Knockout.DateBindingHandler

LxnBase.Knockout.DateBindingHandler = function LxnBase_Knockout_DateBindingHandler() {
    LxnBase.Knockout.DateBindingHandler.initializeBase(this);
}
LxnBase.Knockout.DateBindingHandler.prototype = {
    
    update: function LxnBase_Knockout_DateBindingHandler$update(element, valueAccessor, allBindingsAccessor, viewModel) {
        ...
        if (Type.canCast(value, Date)) {
            $(element).text(value.format('d.m.Y'));
        }
    }
}
...
LxnBase.Knockout.FixedBindingHandler.prototype = {
    ...
    update: function LxnBase_Knockout_FixedBindingHandler$update(element, valueAccessor, allBindingsAccessor, viewModel) {
        ...
        if (!ss.isValue(value)) {
        ...
        else if (LxnBase.NumberUtility.isNumber(value)) {
            var num = value;
            value = num.format('n');
            if (num < 0) {
            ...
            var moneyString = value.MoneyString;
            if (ss.isValue(moneyString)) {
                value = ko.utils.unwrapObservable(moneyString);
            }
            else {
...
LxnBase.Knockout.ViewBindingHandler.prototype = {
    ...
    update: function LxnBase_Knockout_ViewBindingHandler$update(element, valueAccessor, allBindingsAccessor, viewModel) {
        ...
        if (Type.canCast(value, Array)) {
            var arr = value;
            $(element).text(arr[LxnBase.Data.Reference.NamePos]).click(function() {
                LxnBase.UI.FormsRegistry.viewObject(arr[LxnBase.Data.Reference.TypePos], arr[LxnBase.Data.Reference.IdPos]);
            });
        }
        else {
            var obj = value;
            $(element).text(obj.Name).click(function() {
...
LxnBase.UI.BaseClassViewForm.prototype = {
    ...
    onEdit: function LxnBase_UI_BaseClassViewForm$onEdit() {
        LxnBase.UI.FormsRegistry.editObject(this._type, this._id$6, null, ss.Delegate.create(this, function(result) {
            var response = result;
    ...
    onCopy: function LxnBase_UI_BaseClassViewForm$onCopy() {
        ...
        LxnBase.UI.FormsRegistry.editObject(this._type, null, dictionary, ss.Delegate.create(this, function(result) {
            var objId = (result).Item.Id;
            LxnBase.UI.FormsRegistry.viewObject(this._type, objId);
        }), null);
    },
    ...
    onDeleteInstance: function LxnBase_UI_BaseClassViewForm$onDeleteInstance() {
        LxnBase.UI.MessageBoxWrap.confirm(LxnBase.BaseRes.confirmation, LxnBase.BaseRes.delete_Confirmation, ss.Delegate.create(this, function(button, text) {
            ...
            LxnBase.Services.GenericService.Delete(this._type, [ this._id$6 ], null, ss.Delegate.create(this, function(result) {
                var response = result;
                if (response.Success) {
                    this.close();
    ...
    _onDeleteFailed$6: function LxnBase_UI_BaseClassViewForm$_onDeleteFailed$6() {
        LxnBase.Services.GenericService.CanReplace(this._type, this._id$6, ss.Delegate.create(this, function(result) {
            if (result) {
                var form = new LxnBase.UI.ReplaceForm(this._type, this._id$6);
...
LxnBase.UI.BaseEditForm.isFieldModified = function LxnBase_UI_BaseEditForm$isFieldModified(field) {
...
LxnBase.UI.BaseEditForm.textComponent = function LxnBase_UI_BaseEditForm$textComponent(html) {
    /// <param name="html" type="String">
    /// </param>
    /// <returns type="Ext.BoxComponent"></returns>
    return new Ext.BoxComponent(new Ext.BoxComponentConfig().autoEl({ tag: 'div', html: html }).cls('x-form-item float-left box-label').toDictionary());
}
LxnBase.UI.BaseEditForm.rowPanel = function LxnBase_UI_BaseEditForm$rowPanel(items) {
    /// <param name="items" type="Array" elementType="Component">
    /// </param>
...
LxnBase.UI.BaseEditForm.prototype = {
    ...
    isModified: function LxnBase_UI_BaseEditForm$isModified() {
        ...
        var $enum1 = ss.IEnumerator.getEnumerator(this._fields);
        while ($enum1.moveNext()) {
            var field = $enum1.current;
            if (LxnBase.UI.BaseEditForm.isFieldModified(field)) {
                return true;
            }
        }
        return false;
    ...
    _onWindowAfterRender: function LxnBase_UI_BaseEditForm$_onWindowAfterRender() {
        ...
        var $enum1 = ss.IEnumerator.getEnumerator(this._componentSequence);
        while ($enum1.moveNext()) {
            var component = $enum1.current;
            if (component.hidden) {
                continue;
            }
    ...
    emptyRow: function LxnBase_UI_BaseEditForm$emptyRow(rowCount) {
        /// <param name="rowCount" type="Number" integer="true">
        /// </param>
        /// <returns type="Ext.Panel"></returns>
        if (!ss.isValue(rowCount)) {
            rowCount = 1;
        }
        return new Ext.Panel(new Ext.PanelConfig().height(29 * rowCount).toDictionary());
    },
    
    tabPanel: function LxnBase_UI_BaseEditForm$tabPanel(height, items) {
...
LxnBase.UI.FieldNavigationManager = function LxnBase_UI_FieldNavigationManager(components) {
    ...
    var $enum1 = ss.IEnumerator.getEnumerator(this._controlSequence);
    while ($enum1.moveNext()) {
        var control = $enum1.current;
        this._registerFocus(control);
    }
}
...
LxnBase.UI.FieldNavigationManager.prototype = {
    ...
    handleKeyEvent: function LxnBase_UI_FieldNavigationManager$handleKeyEvent(e) {
        /// <param name="e" type="jQueryEvent">
        /// </param>
        /// <returns type="Boolean"></returns>
        if (e.which !== Ext.EventObject.ENTER || e.ctrlKey || e.altKey) {
            return false;
        }
        ...
        if (Type.canCast(component, Ext.form.TextArea) && !e.shiftKey) {
            return true;
        }
...
LxnBase.UI.ReplaceForm = function LxnBase_UI_ReplaceForm(type, id) {
    ...
    /// </field>
    /// <field name="_objectForReplace$1" type="LxnBase.Data.Reference">
    /// </field>
...
LxnBase.UI.ReplaceForm.exec = function LxnBase_UI_ReplaceForm$exec(className, id, tab) {
    /// <param name="className" type="String">
    /// </param>
    /// <param name="id" type="Object">
    /// </param>
    ...
    /// </param>
    LxnBase.Services.GenericService.CanReplace(className, id, function(result) {
        if (result) {
            var form = new LxnBase.UI.ReplaceForm(className, id);
            if (ss.isValue(tab)) {
                form.add_saved(function() {
...
LxnBase.UI.ReplaceForm.prototype = {
    ...
    _renderMessage$1: function LxnBase_UI_ReplaceForm$_renderMessage$1() {
        /// <returns type="String"></returns>
        var text = String.format('<b>{0}</b>', this._objectForReplace$1.Name);
    ...
    _createFormItems$1: function LxnBase_UI_ReplaceForm$_createFormItems$1() {
        ...
        this._replacingObjectSelector$1 = new LxnBase.UI.Controls.ObjectSelector(new LxnBase.UI.Controls.ObjectSelectorConfig().setClass(this._type$1).selectOnFocus(true).width(250).name('replacingObject').hideLabel(true).labelSeparator(''));
    ...
    onSave: function LxnBase_UI_ReplaceForm$onSave() {
        var newId = this._replacingObjectSelector$1.getObjectId();
        if (ss.isValue(newId)) {
            LxnBase.Services.GenericService.Replace(this._type$1, this._id$1, newId, true, ss.Delegate.create(this, this.completeSave), null);
        }
        else {
            Ext.MessageBox.confirm('\u0417\u0430\u043c\u0435\u043d\u0430', '\u0412\u044b \u043d\u0435 \u0432\u044b\u0431\u0440\u0430\u043b\u0438 \u043d\u043e\u0432\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435. \u0412\u0441\u0435 \u0441\u0432\u044f\u0437\u0438 \u0431\u0443\u0434\u0443\u0442 \u0437\u0430\u043c\u0435\u043d\u0435\u043d\u044b \u043d\u0430 \u043f\u0443\u0441\u0442\u043e\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435. \u0412\u044b \u0443\u0432\u0435\u0440\u0435\u043d\u044b?', ss.Delegate.create(this, function() {
                LxnBase.Services.GenericService.Replace(this._type$1, this._id$1, newId, true, ss.Delegate.create(this, this.completeSave), null);
            }));
        }
    },
    ...
    onSaved: function LxnBase_UI_ReplaceForm$onSaved(result) {
        /// <param name="result" type="Object">
        /// </param>
        LxnBase.MessageRegister.info(this._itemConfig$1.ListCaption, String.format(LxnBase.BaseRes.replaceForm_ReplaceComplete_Msg, this._objectForReplace$1.Name, this._replacingObjectSelector$1.getObjectName()));
...
LxnBase.UI.AutoControls.AutoGrid.prototype = {
    ...
    reloadWithData: function LxnBase_UI_AutoControls_AutoGrid$reloadWithData(values) {
        ...
        this.reload(false);
        this.get_selectionModel().selectRow(values.SelectedRow);
    },
    ...
    getSelectedItems: function LxnBase_UI_AutoControls_AutoGrid$getSelectedItems() {
        /// <returns type="Array" elementType="Reference"></returns>
        var records = this.get_selectionModel().getSelections();
    ...
    _getInfo$7: function LxnBase_UI_AutoControls_AutoGrid$_getInfo$7(record) {
        ...
        var info = new LxnBase.Data.Reference();
        info.Id = record.id;
        info.Name = this._resolveReferenceText$7(record);
    ...
    _getColumnsConfig$7: function LxnBase_UI_AutoControls_AutoGrid$_getColumnsConfig$7() {
        ...
        while ($enum1.moveNext()) {
            ...
            if (!this._args.mode && renderer == null && config.IsReference && LxnBase.UI.FormsRegistry.hasViewForm(this._args.type)) {
                renderer = LxnBase.UI.AutoControls.ControlFactory.createRefrenceRenderer(this._args.type);
            }
            var editor = null;
            ...
            var cfg = new Ext.grid.ColumnConfig().id(config.Name).header(config.Caption || config.Name).sortable(config.IsPersistent).dataIndex(config.Name).hidden((isVisiblePropertiesPassed) ? !this._baseRequest$7.VisibleProperties.contains(config.Name) : config.Hidden);
            if (renderer != null) {
    ...
    _createActionToolbar$7: function LxnBase_UI_AutoControls_AutoGrid$_createActionToolbar$7() {
        ...
        var list = [];
        if (!this._args.mode) {
            if (this.get_listConfig().IsCreationAllowed.Visible && !this.get_listConfig().UseCustomCreation) {
                this._createAction$7 = new Ext.Action(new Ext.ActionConfig().text(LxnBase.BaseRes.createItem_Lower).handler(ss.Delegate.create(this, function() {
                    this.create(this._args.type);
                })).disabled(this.get_listConfig().IsCreationAllowed.IsDisabled).custom('tooltip', this.get_listConfig().IsCreationAllowed.DisableInfo).toDictionary());
                list.add(this._createAction$7);
            }
            if (this.get_listConfig().IsEditAllowed.Visible) {
                this._editAction$7 = new Ext.Action(new Ext.ActionConfig().text(LxnBase.BaseRes.edit_Lower).disabled(true).handler(ss.Delegate.create(this, this.edit)).custom('tooltip', this.get_listConfig().IsEditAllowed.DisableInfo).toDictionary());
    ...
    create: function LxnBase_UI_AutoControls_AutoGrid$create(type) {
        /// <param name="type" type="String">
        /// </param>
        if (ss.isNullOrUndefined(type)) {
            type = this._args.type;
        }
        LxnBase.UI.FormsRegistry.editObject(type, null, null, ss.Delegate.create(this, function(result) {
            var response = result;
    ...
    edit: function LxnBase_UI_AutoControls_AutoGrid$edit() {
    ...
    _onMultipleDeleteFailed$7: function LxnBase_UI_AutoControls_AutoGrid$_onMultipleDeleteFailed$7(objects, records) {
        ...
        for (var i = 0; i < objects.length; i++) {
            ...
            var val = objects[i];
            msg.append(String.format('<div>{0}</div>', val[LxnBase.Data.Reference.NamePos]));
        }
        msg.append('</div>');
            ...
            LxnBase.UI.MessageBoxWrap.show(LxnBase.BaseRes.warning, msg.toString(), Ext.MessageBox.WARNING, Ext.MessageBox.YESNO, ss.Delegate.create(this, function(button, text1) {
                ...
                while ($enum1.moveNext()) {
                    ...
                    while ($enum2.moveNext()) {
                        ...
                        if (val[LxnBase.Data.Reference.IdPos] === record.id) {
    ...
    _recordListToString$7: function LxnBase_UI_AutoControls_AutoGrid$_recordListToString$7(selected, separator) {
        ...
        while ($enum1.moveNext()) {
            ...
            if (Type.canCast(value, Array)) {
                value = (value)[LxnBase.Data.Reference.NamePos];
            }
            if (Type.canCast(value, Date)) {
...
LxnBase.UI.AutoControls.AutoGridArgs.prototype = {
    ...
    setDefaultSort: function LxnBase_UI_AutoControls_AutoGridArgs$setDefaultSort(column, dir) {
        /// <param name="column" type="String">
        /// </param>
        /// <param name="dir" type="String">
        /// </param>
        if (this.baseRequest.sort == null) {
            this.baseRequest.sort = column;
            this.baseRequest.dir = dir;
        }
    }
}
...
LxnBase.UI.AutoControls.ControlFactory = function LxnBase_UI_AutoControls_ControlFactory() {
    /// <field name="minWidth" type="Number" integer="true" static="true">
    /// </field>
    /// <field name="maxWidth" type="Number" integer="true" static="true">
    /// </field>
    /// <field name="defaultTextFieldWidth" type="Number" integer="true" static="true">
    /// </field>
    /// <field name="defaultNumberFieldWidth" type="Number" integer="true" static="true">
    /// </field>
...
LxnBase.UI.AutoControls.ControlFactory.createRenderer = function LxnBase_UI_AutoControls_ControlFactory$createRenderer(columnConfig) {
    ...
    if (columnConfig.Type === 1) {
        return LxnBase.UI.AutoControls.ControlFactory.getNumberRenderer(columnConfig, 2);
    }
...
LxnBase.UI.AutoControls.ControlFactory.createRefrenceRenderer = function LxnBase_UI_AutoControls_ControlFactory$createRefrenceRenderer(type) {
    /// <param name="type" type="String">
    /// </param>
    ...
    return function(value, metadata, record, rowIndex, colIndex, store) {
        ...
        values[LxnBase.Data.Reference.IdPos] = record.id;
        values[LxnBase.Data.Reference.NamePos] = value;
        var tp = record.data.__class;
        values[LxnBase.Data.Reference.TypePos] = (ss.isNullOrUndefined(tp)) ? type : tp;
    ...
    return function(value) {
        ...
        if (values != null) {
            if (config.RenderAsString) {
                return values[LxnBase.Data.Reference.NamePos];
            }
            if (ss.isNullOrUndefined(values[LxnBase.Data.Reference.TypePos])) {
                values[LxnBase.Data.Reference.TypePos] = config.Clazz;
            }
            return LxnBase.UI.Controls.ObjectLink.renderArray(values);
        }
        var info = value;
...
LxnBase.UI.AutoControls.ControlFactory._getListRenderer = function LxnBase_UI_AutoControls_ControlFactory$_getListRenderer(config) {
    ...
    return function(value) {
        ...
        if (Type.canCast(value, Array)) {
            return (value)[LxnBase.Data.Reference.NamePos];
        }
        for (var i = 0; i < config.Items.length; i++) {
            var values = config.Items[i];
            if (!ss.isNullOrUndefined(values[LxnBase.Data.Reference.IdPos]) && values[LxnBase.Data.Reference.IdPos] === value) {
                return values[LxnBase.Data.Reference.NamePos];
            }
        }
        return value;
...
LxnBase.UI.AutoControls.ControlFactory.getNumberRenderer = function LxnBase_UI_AutoControls_ControlFactory$getNumberRenderer(config, precision) {
    /// <param name="config" type="LxnBase.Services.NumberColumnConfig">
    /// </param>
    /// <param name="precision" type="Number" integer="true">
    /// </param>
    /// <returns type="Function"></returns>
    return function(value) {
        if (ss.isNullOrUndefined(value)) {
        ...
        if (!ss.isValue(precision)) {
            precision = 0;
        }
        var str = (config.IsInteger) ? value.toString() : (value).format('N' + precision);
...
LxnBase.UI.AutoForms.AutoEditForm.prototype = {
    ...
    onSave: function LxnBase_UI_AutoForms_AutoEditForm$onSave() {
        ...
        if (this.get_localMode()) {
            ...
            this.completeSave(LxnBase.Data.ItemResponse.create(data));
        }
...
LxnBase.UI.AutoForms.AutoListTab.prototype = {
    ...
    get_selectedRecords: function LxnBase_UI_AutoForms_AutoListTab$get_selectedRecords() {
        /// <value type="Array" elementType="Record"></value>
        return this._autoGrid$6.get_selectionModel().getSelections();
    },
...
LxnBase.UI.AutoForms.AutoViewForm.prototype = {
    ...
    onLoad: function LxnBase_UI_AutoForms_AutoViewForm$onLoad() {
        ...
        if (caption == null) {
            caption = this.get_itemConfig().Caption || this._type;
        }
...
LxnBase.UI.Controls.ColumnFilters.ListFilter.prototype = {
    ...
    getFilterMenu: function LxnBase_UI_Controls_ColumnFilters_ListFilter$getFilterMenu() {
        ...
        for (var i = 0; i < config.Items.length; i++) {
            ...
            this._checkItems$1.add(new Ext.menu.CheckItem(new Ext.menu.CheckItemConfig().text(item[LxnBase.Data.Reference.NamePos]).checked_(this._isChecked$1(item[LxnBase.Data.Reference.IdPos])).listeners({ checkchange: ss.Delegate.create(this, this._checkChanged$1) }).hideOnClick(false).custom('checkItemId', item[LxnBase.Data.Reference.IdPos]).toDictionary()));
        }
        var items = [];
...
LxnBase.UI.Controls.ComboBox._normalizeValue$7 = function LxnBase_UI_Controls_ComboBox$_normalizeValue$7(val) {
    ...
    if (val != null && !(Type.canCast(val, Array))) {
        var values = new Array(3);
        values[LxnBase.Data.Reference.IdPos] = (val).Id;
        values[LxnBase.Data.Reference.NamePos] = (val).Name;
        values[LxnBase.Data.Reference.TypePos] = (val).Type;
        return values;
    }
    return val;
}
LxnBase.UI.Controls.ComboBox.prototype = {
    ...
    setValue: function LxnBase_UI_Controls_ComboBox$setValue(val) {
        ...
        else if (!ss.isNullOrUndefined((val).Id) && !ss.isNullOrUndefined((val).Name)) {
        ...
        LxnBase.UI.Controls.ComboBox.callBaseMethod(this, 'setValue', [ values[LxnBase.Data.Reference.NamePos] ]);
    ...
    getObjectInfo: function LxnBase_UI_Controls_ComboBox$getObjectInfo() {
        ...
        var info = new LxnBase.Data.Reference();
        info.Id = array[LxnBase.Data.Reference.IdPos];
        info.Name = array[LxnBase.Data.Reference.NamePos];
        info.Type = array[LxnBase.Data.Reference.TypePos];
        return info;
    },
    
    getSelectedId: function LxnBase_UI_Controls_ComboBox$getSelectedId() {
        /// <returns type="Object"></returns>
        return (this._values$7 == null) ? null : this._values$7[LxnBase.Data.Reference.IdPos];
    },
...
LxnBase.UI.Controls.DecimalField = function LxnBase_UI_Controls_DecimalField(config) {
    ...
    if (!ss.isValue(this.decimalPrecision) || !this.decimalPrecision) {
...
LxnBase.UI.Controls.DecimalField.prototype = {
    ...
    setValue: function LxnBase_UI_Controls_DecimalField$setValue(v) {
        ...
        if (ss.isNullOrUndefined(v)) {
            ...
            var decimals = Math.pow(10, this.decimalPrecision);
            v = (isNaN(v)) ? '' : ((Math.round(v * decimals) / decimals)).toFixed(this.decimalPrecision).replaceAll('.', this.decimalSeparator);
        }
        this.value = v;
        this.setRawValue(v);
        if (this.rendered) {
...
LxnBase.UI.Controls.ObjectLink.render = function LxnBase_UI_Controls_ObjectLink$render(id, text, type) {
    ...
    /// </param>
    /// <returns type="String"></returns>
    return "<a href='#' class='object-link' onclick='" + (LxnBase.UI.Controls.ObjectLink).get_fullName() + '.viewObject(event, ' + JSON.stringify(type) + ', ' + JSON.stringify(id) + ")'>" + text + '</a>';
}
LxnBase.UI.Controls.ObjectLink.renderInfo = function LxnBase_UI_Controls_ObjectLink$renderInfo(info) {
    /// <param name="info" type="LxnBase.Data.Reference">
    /// </param>
    /// <returns type="String"></returns>
    return (ss.isValue(info)) ? LxnBase.UI.Controls.ObjectLink.render(info.Id, info.Name, info.Type) : '';
}
LxnBase.UI.Controls.ObjectLink.renderInfos = function LxnBase_UI_Controls_ObjectLink$renderInfos(infos) {
    /// <param name="infos" type="Array" elementType="Reference">
    /// </param>
    /// <returns type="String"></returns>
    if (ss.isNullOrUndefined(infos)) {
        return '';
    }
    var s = '';
    ...
    while ($enum1.moveNext()) {
        ...
        s += LxnBase.UI.Controls.ObjectLink.renderInfo(info) + ' ';
    }
    return s;
}
LxnBase.UI.Controls.ObjectLink.referencesRenderer = function LxnBase_UI_Controls_ObjectLink$referencesRenderer(columnName) {
    /// <param name="columnName" type="String">
    /// </param>
    /// <returns type="Function"></returns>
    return function(value, metadata, record, rowIndex, colIndex, store) {
        return LxnBase.UI.Controls.ObjectLink.renderInfos(Type.safeCast(record.get(columnName), Array));
    };
}
LxnBase.UI.Controls.ObjectLink.renderArray = function LxnBase_UI_Controls_ObjectLink$renderArray(values) {
    ...
    /// </param>
    /// <returns type="String"></returns>
    return LxnBase.UI.Controls.ObjectLink.render(values[LxnBase.Data.Reference.IdPos], values[LxnBase.Data.Reference.NamePos], values[LxnBase.Data.Reference.TypePos]);
}
LxnBase.UI.Controls.ObjectLink.renderValue = function LxnBase_UI_Controls_ObjectLink$renderValue(value) {
    /// <param name="value" type="Object">
    /// </param>
    /// <returns type="String"></returns>
    var arr = Type.safeCast(value, Array);
    if (arr != null) {
        return LxnBase.UI.Controls.ObjectLink.renderArray(arr);
    }
    var info = value;
    return LxnBase.UI.Controls.ObjectLink.renderInfo(info);
}
...
LxnBase.UI.Controls.ObjectSelector.prototype = {
    ...
    getObjectName: function LxnBase_UI_Controls_ObjectSelector$getObjectName() {
        /// <returns type="Object"></returns>
        var info = this._comboBox.getObjectInfo();
    ...
    _render: function LxnBase_UI_Controls_ObjectSelector$_render() {
        ...
        var parts = [];
        parts.add('<tpl for=".">');
        parts.add('<div class="{[values.' + 'Action' + ' ? "x-combo-list-item combo-list-action" : values.' + 'IsCaption' + ' ? "x-combo-list-item combo-list-caption" : "x-combo-list-item"]}">{' + 'Name' + '}</div>');
        parts.add('</tpl>');
    ...
    _onLoadData: function LxnBase_UI_Controls_ObjectSelector$_onLoadData(store, records, options) {
        ...
        if (records == null || !records.length || String.isNullOrEmpty(this._comboBox.getRawValue())) {
            var data = {};
            data['Name'] = LxnBase.BaseRes.noData_Text;
            data['Id'] = -1;
            data['IsCaption'] = true;
    ...
    _onEditClick: function LxnBase_UI_Controls_ObjectSelector$_onEditClick() {
        ...
        var id = (value == null) ? null : value[LxnBase.Data.Reference.IdPos];
        var clazz = ((value == null || value[LxnBase.Data.Reference.TypePos] == null) ? this._config.get_clazz() : value[LxnBase.Data.Reference.TypePos]);
        LxnBase.UI.FormsRegistry.editObject(clazz, id, null, ss.Delegate.create(this, function(result) {
            var response = result;
            var info = new LxnBase.Data.Reference();
            info.Id = response.Item.Id;
            info.Name = response.Item.__reference;
...
LxnBase.UI.Controls.ObjectSelectorConfig.prototype = {
    ...
    setValue: function LxnBase_UI_Controls_ObjectSelectorConfig$setValue(val) {
        /// <param name="val" type="LxnBase.Data.Reference">
        /// </param>
        /// <returns type="LxnBase.UI.Controls.ObjectSelectorConfig"></returns>
        if (!ss.isNullOrUndefined(val)) {
            this.value([ val.Id, val.Name ]);
        }
        return this;
    },
...
LxnBase.Log.registerClass('LxnBase.Log');
LxnBase.Data.RangeRequest.registerClass('LxnBase.Data.RangeRequest');
LxnBase.Data.Reference.registerClass('LxnBase.Data.Reference');
...
LxnBase.Knockout.DateBindingHandler.registerClass('LxnBase.Knockout.DateBindingHandler', Object);
...
LxnBase.Data.Reference.IdPos = 0;
LxnBase.Data.Reference.NamePos = 1;
LxnBase.Data.Reference.TypePos = 2;
LxnBase.Data.ConfigManager._listConfigs = {};
LxnBase.Data.ConfigManager._viewConfigs = {};
LxnBase.Data.ConfigManager._editConfigs = {};
LxnBase.Data.ObjectPropertyNames.id = 'Id';
LxnBase.Data.ObjectPropertyNames.version = 'Version';
LxnBase.Data.ObjectPropertyNames.name = 'Name';
LxnBase.Data.ObjectPropertyNames.type = 'Type';
LxnBase.Data.ObjectPropertyNames.reference = '__reference';
LxnBase.Data.ObjectPropertyNames.objectClass = '__class';
...
(function () {
    ko.bindingHandlers['date'] = new LxnBase.Knockout.DateBindingHandler();
})();
...
LxnBase.UI.AutoControls.ControlFactory.minWidth = 70;
LxnBase.UI.AutoControls.ControlFactory.maxWidth = 230;
LxnBase.UI.AutoControls.ControlFactory.defaultTextFieldWidth = 180;
LxnBase.UI.AutoControls.ControlFactory.defaultNumberFieldWidth = 87;
